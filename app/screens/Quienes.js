    ...
    return (
        <View style={styles.content}>
            <ImageBackground source={require("../../assets/fondos/fondohome.jpg")} resizeMode="cover" style={styles.image}>
                ...
                <ScrollView >
                    <Text style={styles.text}>Nosotros somos Cecilia, Bryan, Joel y Mauricio, nos encanta la Tecnología.
                        Dado que la programación es nuestra pasión, codificamos la app CLIMARG como proyecto educativo. 
                        ...
                        Así nació CLIMARG nuestro objetivo es mantener a CLIMARG para que sea accesible en los lugares más remotos de nuestro país y 
                    ...
                    <Text style={styles.text}>- Fuente de datos: API Weather</Text>
